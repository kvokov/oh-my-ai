...
| [nestjs](skills/nestjs/)                           | NestJS production patterns — tiered architecture, DI, validation, security, errors, persistence, APIs, microservices — with companion `rules/` for deep dives. |
