---
name: api-use-dto-serialization
description: Use DTOs and Serialization for API Responses — Response DTOs prevent accidental data exposure and ensure consistency
...
Never return entity objects directly from controllers. Use response DTOs with **class-transformer** serialization decorators (Exclude and Expose on entity or response classes) so you control exactly what data is sent to clients. This prevents accidental exposure of sensitive fields and provides a stable API contract.
...
**Correct (class-transformer with Exclude markers and response DTOs):**
