---
name: devops-use-config-module
description: Use ConfigModule for Environment Configuration — Proper configuration prevents deployment failures
...
Use the [NestJS configuration module](https://docs.nestjs.com/techniques/configuration) for environment-based configuration. Validate configuration at startup to fail fast on misconfigurations. Use namespaced configuration for organization and type safety.
...
**Correct (ConfigModule with validation):**
